...
#Onko nämä nyt oikeassa järjestyksessä, monomer1 on eka ja monomer2 toka?
#data_file=/Users/osmalama/projects/TFBS/PWMs_final_version2.2/metadata_3993_motifs.csv
...
cd /Users/osmalama/spacek/Figures_version2.2_rev_comp_Logos/svg/
for file in *.svg; do
