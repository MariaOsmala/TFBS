...
#!/bin/bash
array=$1 #When 3294 motifs varies between 0 and 329
...
#outfolder=/scratch/project_2006203/TFBS/Results/MOODS_human_final_union/ #version2
...
pwms=($(ls ../PWMs_final_union/*/pwms_space/*/*.pfm)) #Should be 4003
nro_pwms=${#pwms[@]} #4003, earlier 3294
...
#old: index is from 0 to 3293
#index is from 0 to 4002
