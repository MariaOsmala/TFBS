...
#!/bin/bash
array=$1 #this varies between 0 and 329
...
S=/projappl/project_2007567/Genomes/mm39/mm39.fa

#outfolder=/scratch/project_2006203/TFBS/Results/MOODS_mouse_mm39_final/
outfolder=/scratch/project_2006203/TFBS/Results/MOODS_mouse_mm39_final_whole_genome/
mkdir $outfolder


n=300000 #the number of best hits

pwms=($(ls ../PWMs_final/*/pwms_space/*/*.pfm)) #3982+15=3997
