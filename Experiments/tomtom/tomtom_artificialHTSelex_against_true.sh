...
query_file=../PWMs_final_version2.2/half-site-motifs.meme 

target_file=../PWMs_final_version2.2/all.meme


results_path=/scratch/project_2006203/Results/tomtom_final_version2.2/tomtom_relaxed_artificialHTSelex_against_version2.2
mkdir -p $results_path

tomtom -dist kullback -motif-pseudo 0.1 -thresh 1 -min-overlap 1 $query_file $target_file -oc $results_path
