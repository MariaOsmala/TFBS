...
srun apptainer_wrapper exec Rscript --no-save ../../code/motif-match-enrichment-at-cell-type-specific-cCREs/enrichment_at_CREs_final_all_motifs_parts.R $SLURM_ARRAY_TASK_ID #all 3294 motifs
