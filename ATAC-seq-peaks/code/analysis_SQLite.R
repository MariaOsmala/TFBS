...
#How the database was created, earlier
...
p_matrix=matrix(nrow=length(motif_names$PWM), ncol=length(cCREs_list),
                dimnames = list( motif_names$PWM,
                                names(cCREs_list) )) #1062 x 111

e_matrix=matrix(nrow=length(motif_names$PWM), ncol=length(cCREs_list),
                dimnames = list(motif_names$PWM,
                                names(cCREs_list) )) #1062 x 111
