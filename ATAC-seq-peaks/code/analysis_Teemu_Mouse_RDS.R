...
match_numbers=unlist(lapply(all_motif_matches_mouse, length))
saveRDS(match_numbers,"/scratch/project_2006203/TFBS/ATAC-seq-peaks/RData/match_numbers_mouse.Rds")

#match_numbers=readRDS("/scratch/project_2006203/TFBS/ATAC-seq-peaks/RData/match_numbers_mouse.Rds")

rerun=which(match_numbers < 300000) #1001  CTCF: 54530 
