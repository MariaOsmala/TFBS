...
top_files=files[grep("top", files)]

files=files[-which(files %in% top_files)]
...
#saveRDS(GR_list,  file = paste0( "../RData/all_motif_matches_Teemu.Rds")) #
saveRDS(GR_list,  file = paste0(data_path, "/ATAC-seq-peaks/RData/all_motif_matches_Teemu.Rds")) #
