...
dir.create(file.path(data_path, "PWMs_final_version2/Logos_final"), showWarnings = FALSE)
dir.create(file.path(paste0(data_path, "/PWMs_final_version2/Logos_final"), "pdf"), showWarnings = FALSE)
dir.create(file.path(paste0(data_path, "/PWMs_final_version2/Logos_final"), "png"), showWarnings = FALSE)
dir.create(file.path(paste0(data_path, "/PWMs_final_version2/Logos_final/pdf"), "barcode"), showWarnings = FALSE)
dir.create(file.path(paste0(data_path, "/PWMs_final_version2/Logos_final/pdf"), "ic"), showWarnings = FALSE)
dir.create(file.path(paste0(data_path, "/PWMs_final_version2/Logos_final/pdf"), "prob"), showWarnings = FALSE)
dir.create(file.path(paste0(data_path, "/PWMs_final_version2/Logos_final/png"), "barcode"), showWarnings = FALSE)
dir.create(file.path(paste0(data_path, "/PWMs_final_version2/Logos_final/png"), "ic"), showWarnings = FALSE)
dir.create(file.path(paste0(data_path, "/PWMs_final_version2/Logos_final/png"), "prob"), showWarnings = FALSE)

dir.create(file.path(data_path, "PWMs_final_version2/Logos_final2"), showWarnings = FALSE)
dir.create(file.path(paste0(data_path, "/PWMs_final_version2/Logos_final2"), "pdf"), showWarnings = FALSE)
dir.create(file.path(paste0(data_path, "/PWMs_final_version2/Logos_final2"), "png"), showWarnings = FALSE)
dir.create(file.path(paste0(data_path, "/PWMs_final_version2/Logos_final2/pdf"), "barcode"), showWarnings = FALSE)
dir.create(file.path(paste0(data_path, "/PWMs_final_version2/Logos_final2/pdf"), "ic"), showWarnings = FALSE)
dir.create(file.path(paste0(data_path, "/PWMs_final_version2/Logos_final2/pdf"), "prob"), showWarnings = FALSE)
dir.create(file.path(paste0(data_path, "/PWMs_final_version2/Logos_final2/png"), "barcode"), showWarnings = FALSE)
dir.create(file.path(paste0(data_path, "/PWMs_final_version2/Logos_final2/png"), "ic"), showWarnings = FALSE)
dir.create(file.path(paste0(data_path, "/PWMs_final_version2/Logos_final2/png"), "prob"), showWarnings = FALSE)
...
representatives <- read_delim("~/projects/TFBS/PWMs_final_version2/metadata.csv", 
                       delim = "\t", escape_double = FALSE, 
                       trim_ws = TRUE)

representatives=representatives %>% filter(study=="fromYimeng_version2")
...
for(i in 1:nrow(representatives)){
  ...
  png(paste0(data_path,"/PWMs_final_version2/Logos_final2/png/prob/",representatives$ID[i],".png"), res=600,  width = 2500/4*representatives$length[i], height = 2500)
  ...
  pdf(paste0(data_path,"/PWMs_final_version2/Logos_final2/pdf/prob/",representatives$ID[i],".pdf"), width =representatives$length[i], height = 4, onefile=FALSE)
  print(motifStack::plotMotifLogo( pwm_class@profileMatrix, motifName=pwm_class@name, ic.scale = FALSE, 
                             ylab="probability", font="mono,Courier", fontface = "bold"))
  dev.off()
  
  png(paste0(data_path,"/PWMs_final_version2/Logos_final/png/prob/",representatives$ID[i],".png"), res=600,  width = 2500/4*representatives$length[i], height = 2500)
  ...
  pdf(paste0(data_path,"/PWMs_final_version2/Logos_final/pdf/prob/",representatives$ID[i],".pdf"), width =representatives$length[i], height = 4, onefile=FALSE)
  print(ggplot() + ggseqlogo::geom_logo(  pwm_class@profileMatrix, method="probability", font="roboto_medium", col_scheme="auto" ) + 
    ggseqlogo::theme_logo()  +
    labs(title=pwm_class@name)+ theme(title =element_text(size=8, face='bold'))+ guides(scale="none"))
  dev.off()
  ...
  png(paste0(data_path,"/PWMs_final_version2/Logos_final2/png/ic/",representatives$ID[i],".png"), res=600,  width = 2500/4*representatives$length[i], height = 2500)
  ...
  pdf(paste0(data_path,"/PWMs_final_version2/Logos_final2/pdf/ic/",representatives$ID[i],".pdf"), width =representatives$length[i], height = 4, onefile=FALSE)
  print(motifStack::plotMotifLogo( pwm_class@profileMatrix, motifName=pwm_class@name, ic.scale = TRUE, 
                             ylab="bits", font="mono,Courier", fontface = "bold"))
  dev.off()
  
  png(paste0(data_path,"/PWMs_final_version2/Logos_final/png/ic/",representatives$ID[i],".png"), res=600,  width = 2500/4*representatives$length[i], height = 2500)
  ...
  pdf(paste0(data_path,"/PWMs_final_version2/Logos_final/pdf/ic/",representatives$ID[i],".pdf"), width =representatives$length[i], height = 4, onefile = FALSE)
  print(ggplot() + ggseqlogo::geom_logo(  pwm_class@profileMatrix, method="bits", font="roboto_medium", col_scheme="auto" ) + 
    ggseqlogo::theme_logo()  +
    labs(title=pwm_class@name)+ theme(title =element_text(size=8, face='bold'))+ guides(scale="none"))
  dev.off()
...
#saveRDS(pcm_list, file=paste0("/scratch/project_2006203/TFBS/RProjects/TFBS/RData/pcm_list_final_fromYimeng_version2.Rds")
#saveRDS(pwm_list, file="/scratch/project_2006203/TFBS/RProjects/TFBS/RData/pwm_list_final_fromYimeng_version2.Rds")
