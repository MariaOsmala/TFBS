...
tomtom = read_tsv('/Users/osmalama/projects/TFBS/Results/tomtom_final_version2.2/tomtom_relaxed/tomtom.tsv') # 15 468 492 rows
...
monomers_halfsites=metadata_halfsites
...
tmp=capselex[which(capselex$first.monomer!="" & capselex$second.monomer!="" ),] #There are 1867 for which both monomers were found
...
#1898 CAP-selex motifs, success for 1838 pairs, fails for 60 pairs
...
#NA        composite   spacing 
#21        42          142 

length(which(spacing_motifs$type_computation!="" & spacing_motifs$type==spacing_motifs$type_computation)) #142 CORRECT
length(which(spacing_motifs$type_computation!="" & spacing_motifs$type!=spacing_motifs$type_computation)) #42 UNCORRECT
...
length(which(composite_motifs$type_computation!="" & composite_motifs$type==composite_motifs$type_computation)) #1030 CORRECT
length(which(composite_motifs$type_computation!="" & composite_motifs$type!=composite_motifs$type_computation)) #66 UNCORRECT
