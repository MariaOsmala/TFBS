...
# Conservation analysis of spacing motif matches, old!
...
/projappl/project_2007567/RProject/spacing_motifs/code/conservation_analysis_of_spacing_motifs_draw_images.R #This draws images based on the results generated by the code above
...
#Draw number of conserver matches as a function of match numbers: 

/projappl/project_2007567/code/process_second_revision_conserved_match_numbers_aafo_match_numbers.R

#count the number of conserved matches of spacing pairs
/projappl/project_2007567/RProject/spacing_motifs/code/second_revision_conserved_match_counts.R
